...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // 在GPU上执行SetGraphicsRootDescriptorTable后，不修改命令列表中的SRV，因此可以使用默认Rang行为:
    ...
    //使用高版本并向下兼容的方法来编译根签名
    D3DX12SerializeVersionedRootSignature(&stRootSignatureDesc
    ...
    stResBar1.Transition.pResource = pITexcute.Get();
    ...
    D3D12_RESOURCE_BARRIER stResBar2 = {};
    stResBar2.Type = D3D12_RESOURCE_BARRIER_TYPE_TRANSITION;
    stResBar2.Flags = D3D12_RESOURCE_BARRIER_FLAG_NONE;
    stResBar2.Transition.pResource = pITexcute.Get();
    stResBar2.Transition.StateBefore = D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE;
    stResBar2.Transition.StateAfter = D3D12_RESOURCE_STATE_COPY_DEST;
    stResBar2.Transition.Subresource = D3D12_RESOURCE_BARRIER_ALL_SUBRESOURCES;
    ...
    pICommandList->ResourceBarrier(1, &stResBar2);
